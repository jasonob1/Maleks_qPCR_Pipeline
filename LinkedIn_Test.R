...
server <- function(input, output, session) {
  ...
  RTable <- reactive({
    ...
    selected_table = fullTable() |> select(all_of(input$sPP))
    pcrPositive <- all(selected_table[input$sPP] < highCT)
    ...
    print(selected_table[input$sPP] < highCT)
