...
ui <- fluidPage(
  ...
  # Start a sidebar layout
  sidebarLayout(
    
    # Load data buttons in Side Panel
    sidebarPanel(
      width = 4.5,
    ...
    # Render output$mergedTable in Main Panel
    mainPanel(
